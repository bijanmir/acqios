    ...
    <div class="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="hidden md:flex md:w-1/2 p-8 flex-col justify-center items-center bg-indigo-600 text-white">
            <div class="max-w-md mx-auto">
                ...
                <h1 class="text-3xl font-bold mb-6">Welcome to Acqios</h1>
                <p class="text-xl mb-8">Your trusted marketplace for business opportunities.</p>
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <p>View exclusive business listings</p>
                    </div>
                    <div class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <p>Contact business owners directly</p>
                    </div>
                    <div class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <p>Save favorite listings for later</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-6">
            <div class="w-full max-w-md bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-2 mb-6">Sign in to continue</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" class="w-full pl-10 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="your@email.com">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" class="w-full pl-10 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required autocomplete="current-password" placeholder="••••••••">
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 font-medium hover:underline">
                                Forgot password?
                            </a>
                        @endif
                    </div>
